...
export default function Header() {
  const [isMenuOpen, setIsMenuOpen] = useState(false); // useState: состояние мобильного меню
  const menuRef = useRef(null); // useRef: для отслеживания кликов вне меню

  useEffect(() => { // useEffect: закрытие меню при клике вне
    ...
    <header className="bg-black text-white">
      ...
      <div className="container mx-auto flex justify-between items-center py-4 px-6">
        ...
        >
         ...
         <Link href="/1" className="block md:inline text-gray-400 hover:text-white px-3 py-1 mx-4 md:mx-0">
          News
         </Link>
